  ...
  return (
    <div>
      <footer className="footer-section">
        <img
          src="assets/img/home1/icon/vector-2.svg"
          alt=""
          className="vector1"
        />
        <img
            ...
            <div className="row g-lg-4 gy-5 justify-content-center">
              <div className="col-lg-3 col-md-4 col-sm-6">
                <div className="footer-widget">
                  ...
                  <a href="shop-list.html" className="primary-btn1 hover-btn3">
                    *Shop Now*
                  </a>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-6 d-flex justify-content-lg-start justify-content-sm-end">
                <div className="footer-widget">
                  ...
                  <ul className="widget-list">
                    ...
                    <li>
                      <a href={() => false}>Return &amp; Refunds</a>
                    </li>
                    <li>
                      <a href="shop-list.html">Online Stores</a>
                    </li>
                    <li>
              ...
              <div className="col-lg-2 col-md-4 col-sm-6 d-flex justify-content-lg-center justify-content-md-end">
                <div className="footer-widget">
                  ...
                  <ul className="widget-list">
                    ...
                    <li>
                      <a href="gift-card.html">Gift Offers</a>
                    </li>
                    <li>
                      <a href="blog-grid.html">Latest Posts</a>
                    </li>
                    <li>
              ...
              <div className="col-lg-12 d-flex flex-md-row flex-column align-items-center justify-content-md-between justify-content-center flex-wrap gap-3">
                ...
                <div className="footer-contact">
                  <div className="logo">
                    ...
                    >
                      <g clipPath="url(#clip0_262_41770)">
