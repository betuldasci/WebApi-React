...
function SpecialOfferCounter() {
  ...
  //     // Farkı gün, saat, dakika ve saniyeye çevirin
  ...
  //     // Eğer süre bitti ise intervali durdurun
  //     if (difference < 0) {
  ...
  //   // Komponent yok edildiğinde intervali temizleyin
  ...
  const specialOfferProduct = products.find((product) => product.id === 1);

  if (!specialOfferProduct) {
    return <div>Loading Special Offer...</div>;
  }
            ...
            <div className="row">
              <div className="col-lg-4 p-lg-0">
                <div className="special-offer-left">
                  ...
                  <p>
                    Whatever your summer looks like, bring your own heat with up
                    to 25% off Lumin
                  </p>
                  <div className="hurry-bg">
                    <svg
                      width={65}
                      height={65}
                      viewBox="0 0 65 65"
                  ...
                  <div className="offer-timer">
                    ...
                    <div className="countdown-timer">
                      <ul data-countdown="2023-10-23 12:00:00">
                        <li data-days={0}>{countdownTime.days}</li>
                        <li>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width={4}
                        ...
                        <li data-hours={0}>{countdownTime.hours}</li>
                        <li>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width={4}
                        ...
                        <li data-minutes={0}>{countdownTime.minutes}</li>
                        <li>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width={4}
                        ...
                        <li data-seconds={0}>{countdownTime.seconds}</li>
                      </ul>
                    </div>
                  </div>
                  <a
                    ...
                    <div className="slide-item">
                      <div className="product-card style-4">
                        <div className="product-card-img double-img">
                          ...
                          <div className="overlay">
                            <div className="cart-area">
                              <a
                                onClick={() => handleAddToCart(specialOfferProduct)}
                        ...
                        <div className="product-card-content">
                          ...
                          <p>
                            <a href="shop-list.html">Whispering</a>
                          </p>
                          <p className="price">
                            {specialOfferProduct.price} <del>$200.00</del>
                          </p>
...
export default SpecialOfferCounter