                      ...
                      <div className="banner-wrapper">
                        <div className="banner-left">
                          ...
                          <div className="banner-content">
                            ...
                            <p>
                              Whatever your summer looks like, bring your own
                              heat with up to 25% off Lumin Brand.
                            </p>
                            <a
                              href="shop-list.html"
                        ...
                        <div className="banner-right-wrapper">
                          <div className="banner-right-img">
                            ...
                            />
                            <img
                              src="assets/img/home1/banner-right-bg.png"
                              alt=""
                    ...
                    <div className="swiper-slide">
                      <div className="banner-wrapper">
                        ...
                        <div className="banner-right-wrapper">
                          <div className="banner-right-img">
                            <img
                              src="assets/img/home1/banner-right-bg2.png"
                              alt=""
                              className="banner-right-bg"
                            />
                          </div>
                    ...
                    <div className="swiper-slide">
                      <div className="banner-wrapper">
                        ...
                        <div className="banner-right-wrapper">
                          <div className="banner-right-img">
                            <img
                              src="assets/img/home1/banner-right-bg3.png"
                              alt=""
                              className="banner-right-bg"
                            />
                          </div>
                    ...
                    <div className="swiper-slide">
                      <div className="banner-wrapper">
                        ...
                        <div className="banner-right-wrapper">
                          <div className="banner-right-img">
                            <img
                              src="assets/img/home1/banner-right-bg4.png"
                              alt=""
                              className="banner-right-bg"
                            />
                          </div>
                ...
                <div className="col-lg-3 col-sm-6 d-flex justify-content-lg-start justify-content-center">
                  <div className="banner-footer-item">
                    ...
                    <div className="banner-footer-content">
                      <h5>Free Delivery</h5>
                      <p>
                        Free product delivary after $500 and get descount over
                        the produce.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-lg-3 col-sm-6 d-flex justify-content-center">
                  <div className="banner-footer-item">
                    ...
                    <div className="banner-footer-content">
                      ...
                      <p>
                        Payment will be secure and your card information will
                        not disclosed.
                      </p>
                    </div>
                  </div>
