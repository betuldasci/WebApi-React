...
(function ($) {
  ...
  $(".grid-view li").on("click", function () {
    ...
    targetDiv
      .removeClass()
      .addClass(
        "all-products list-grid-product-wrap " + className + "-wrapper"
      );
  ...
  $(document).on("click", function (e) {
    if (
      !$(e.target).closest(
        ".cart-menu, .header-cart-btn, .search-input, .search-btn"
      ).length
    ) {
  ...
  var swiper = new Swiper(".face-slider", {
    ...
    loop: true,
    draggable: true,
    navigation: { nextEl: ".face-next", prevEl: ".face-prev" },
    breakpoints: {
      280: { slidesPerView: 1, spaceBetween: 15 },
      386: { slidesPerView: 1, spaceBetween: 15 },
      576: { slidesPerView: 2 },
  ...
  var swiper = new Swiper(".body-slider", {
    ...
    loop: true,
    draggable: true,
    navigation: { nextEl: ".body-next", prevEl: ".body-prev" },
    breakpoints: {
      280: { slidesPerView: 1, spaceBetween: 15 },
      386: { slidesPerView: 1, spaceBetween: 15 },
      576: { slidesPerView: 2 },
  ...
  var swiper = new Swiper(".hair-slider", {
    ...
    loop: true,
    draggable: true,
    navigation: { nextEl: ".hair-next", prevEl: ".hair-prev" },
    breakpoints: {
      280: { slidesPerView: 1, spaceBetween: 15 },
      386: { slidesPerView: 1, spaceBetween: 15 },
      576: { slidesPerView: 2 },
  ...
  var swiper = new Swiper(".makeup-slider", {
    ...
    loop: true,
    draggable: true,
    navigation: { nextEl: ".makeup-next", prevEl: ".makeup-prev" },
    breakpoints: {
      280: { slidesPerView: 1, spaceBetween: 15 },
      386: { slidesPerView: 1, spaceBetween: 15 },
      576: { slidesPerView: 2 },
  ...
  var swiper = new Swiper(".category-top-slider", {
    ...
    spaceBetween: 30,
    loop: true,
    navigation: { nextEl: ".ct-top-next-btn", prevEl: ".ct-top-prev-btn" },
    breakpoints: {
      280: { slidesPerView: 1, spaceBetween: 15 },
  ...
  var swiper = new Swiper(".product-full-slider", {
    ...
    spaceBetween: 30,
    loop: true,
    navigation: { nextEl: ".pt-full-next-btn", prevEl: ".pt-full-prev-btn" },
    autoplay: { delay: 2500 },
    breakpoints: {
      280: { slidesPerView: 1, spaceBetween: 15 },
  ...
  var swiper = new Swiper(".sg-slider", {
    ...
    speed: 1000,
    loop: true,
    navigation: { nextEl: ".sg-next-btn", prevEl: ".sg-prev-btn" },
  });
  var swiper = new Swiper(".top-selling-slider", {
    slidesPerView: 1,
    spaceBetween: 30,
    loop: true,
    navigation: { nextEl: ".top-sell-next-btn", prevEl: ".top-sell-prev-btn" },
    breakpoints: {
      280: { slidesPerView: 1, spaceBetween: 15 },
      386: { slidesPerView: 1, spaceBetween: 15 },
      576: { slidesPerView: 2 },
  ...
  $("#slick2").slick({
    ...
    responsive: [
      ...
      { breakpoint: 991, settings: { arrows: true, slidesToShow: 3 } },
  ...
  var swiper = new Swiper(".say-about-slider", {
    ...
    spaceBetween: 40,
    loop: true,
    navigation: { nextEl: ".about-next-btn", prevEl: ".about-prev-btn" },
    pagination: { el: ".swiper-pagination2", clickable: true },
    breakpoints: {
      280: { slidesPerView: 1, spaceBetween: 15 },
      386: { slidesPerView: 1, spaceBetween: 30 },
      576: { slidesPerView: 1 },
      768: { slidesPerView: 2 },
      992: { slidesPerView: 2 },
  ...
  $(function () {
    $(".payment-methods .payment-list li").on("click", function () {
      $(".payment-methods .payment-list li").removeClass("active");
